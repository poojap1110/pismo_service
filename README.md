...
* `POST /v1/account`:  creates a new account
* `GET /v1/account/:id`: returns the detailed information of an account
* `GET /v1/albums/:id`: returns the detailed information of an album
* `POST /v1/transaction`: creates a new transaction
